...
public:
    ...
    /**
     * @brief "Samples" from time 1 proposal. Really, it maps the normal random vector into the sample.
    ...
    /**
     * @brief "Samples" from the proposal/instrumental/importance density at time t. Really, it maps the normal random vector into the sample.
     * @param xtm1 the previous state sample
